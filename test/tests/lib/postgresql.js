...
test.object (postgresql)
    ...
    .expectingMethodToReturnValue ("object.TRANSFORMS.id", "JSONB_EXTRACT_PATH_TEXT (\"data\", 'email')", 'data.email')
    .expectingMethodToReturnValue ("object.TRANSFORMS.id", `"data"->>'email'`, "data->>'email'")
    ...
    .expectingMethodToReturnValue ("object.TRANSFORMS.ne", "IS NOT", null)
    .expectingMethodToReturnValue ("object.TRANSFORMS.ne", "IS NOT", undefined)
