    ...
    return (Self = nit.defineCommand ("postgresql.commands.CreateMigration"))
        ...
        .defineInput (Input =>
        {
            Input
                ...
                .option ("template", "nit.File", "The migration template file.", Self.Migration.template)
                .option ("dir", "nit.Dir", "The directory under which the migration should be generated.", Self.Migration.dir)
