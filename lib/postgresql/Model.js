module.exports = function (nit, postgresql, Self)
{
    ...
    return (Self = nit.defineModel ("postgresql.Model"))
        ...
        .staticMethod ("defineInnerModel", function (name, superclass, builder)
        {
            ({ name, superclass = "postgresql.Model", builder } = nit.typedArgsToObj (arguments,
            {
                name: "string",
                superclass: "string",
                builder: "function"
        ...
        .configureComponentMethod ("update", Queue =>
        {
            Queue
                .onInit (function ()
                {
                    let { data, cascade, options } = nit.typedArgsToObj (this.args,
                    {
                        data: "dto",
                        cascade: "boolean",
                        options: Self.QueryOptions
                ...
                .after ("preUpdate", "preUpdate.validate", async function (entity, data, options)
                {
                    let cls = entity.constructor;
                ...
                .after ("preUpdate.validate", "preUpdate.buildContext", async function (entity, data, options)
                {
                    let cls = entity.constructor;
                ...
                .after ("update.invokeHook", "update.updateRow", async function (entity, ctx)
                {
                    let cls = entity.constructor;
                ...
                .after ("update.updateRow", "update.saveRelatedEntities", async function (entity, ctx)
                {
        ...
        .configureComponentMethod ("insert", Queue =>
        {
            Queue
                .onInit (function ()
                {
                    let { cascade, options } = nit.typedArgsToObj (this.args,
                    {
                        cascade: "boolean",
                        options: Self.QueryOptions
                    });
                ...
                .after ("preInsert", "preInsert.validate", async function (entity, options)
                {
                    let cls = entity.constructor;
                ...
                .after ("preInsert.validate", "preInsert.buildContext", async function (entity, options)
                {
                    let cls = entity.constructor;
                ...
                .after ("insert.invokeHook", "insert.insertRow", async function (entity, ctx)
                {
                    let cls = entity.constructor;
                ...
                .after ("insert.insertRow", "insert.saveRelatedEntities", async function (entity, ctx)
                {
                    if (ctx.options.cascade)
                    {
                        await entity.constructor.saveRelatedEntities (entity);
        ...
        .configureComponentMethod ("delete", Queue =>
        {
            Queue
                .onInit (function ()
                {
                ...
                .after ("preDelete", "preDelete.validate", async function (entity, options)
                {
                    let cls = entity.constructor;
                ...
                .after ("preDelete.validate", "preDelete.buildContext", async function (entity, options)
                {
                    let cls = entity.constructor;
                ...
                .after ("delete.invokeHook", "delete.deleteRow", async function (entity, ctx)
                {
                    let cls = entity.constructor;

                    await cls.db.delete (cls.tableName, ctx.matches);
                })
                .after ("delete.deleteRow", "delete.deleteRelatedEntities", async function (entity, ctx)
                {
                    let cls = entity.constructor;
        ...
        .configureComponentMethod ("save", Queue =>
        {
            Queue
                .onInit (function ()
                {
                ...
                .after ("save.invokeHook", "save.insertOrUpdateEntity", async function (entity, options)
                {
                    let cls = entity.constructor;
