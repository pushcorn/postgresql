module.exports = function (nit, postgresql, Self)
{
    ...
    return (Self = nit.defineModel ("postgresql.Model"))
        ...
        .defineMeta ("tableName", "string")
        .plugin ("event-emitter", "insert", "update", "delete", { prePost: true, listenerName: "Trigger" })
        ...
        {
            Subclass.tableName = Subclass.tableName || nit.pluralize (nit.camelCase (Subclass.simpleName));
        })
        ...
        .staticLifecycleMethod ("prepareTable", null, table => {}) // eslint-disable-line no-unused-vars
        .staticLifecycleMethod ("prepareJoinTable", null, table => {}) // eslint-disable-line no-unused-vars
        .staticLifecycleMethod ("preInsert", null, ctx => {}) // eslint-disable-line no-unused-vars
        .staticLifecycleMethod ("postInsert", null, ctx => {}) // eslint-disable-line no-unused-vars
        .staticLifecycleMethod ("preUpdate", null, ctx => {}) // eslint-disable-line no-unused-vars
        .staticLifecycleMethod ("postUpdate", null, ctx => {}) // eslint-disable-line no-unused-vars
        .staticLifecycleMethod ("preDelete", null, ctx => {}) // eslint-disable-line no-unused-vars
        .staticLifecycleMethod ("postDelete", null, ctx => {}) // eslint-disable-line no-unused-vars
        ...
        .lifecycleMethod ("update", async function (data, cascade, options)
        {
            ...
            await entity.emit ("preUpdate", ctx);
            ...
            await entity.emit ("postUpdate", ctx);
        ...
        .lifecycleMethod ("insert", async function (cascade, options)
        {
            ...
            await entity.emit ("preInsert", ctx);
            ...
            await entity.emit ("postInsert", ctx);
        ...
        .lifecycleMethod ("delete", async function (cascade, options)
        {
            ...
            await entity.emit ("preDelete", ctx);
            ...
            await entity.emit ("postDelete", ctx);
