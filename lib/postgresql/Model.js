module.exports = function (nit, postgresql, Self)
{
    ...
    return (Self = nit.defineModel ("postgresql.Model"))
        ...
        .staticProperty ("registry", "postgresql.Registry",
        {
            getter: function (v)
            {
                return this.registry = (v || this.superclass.registry || new postgresql.Registry);
            }
        })
        .staticProperty ("db", "postgresql.Database",
        {
            getter: function (v)
            {
                return this.db = (v || this.superclass.db || nit.new ("postgresql.Database"));
            }
        })
        ...
        .staticMethod ("rebuild", function ()
        {
            ...
            {
                f = cls.Field (f.toPojo (true)).bind (cls.prototype);
