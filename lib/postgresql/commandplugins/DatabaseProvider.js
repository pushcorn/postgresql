...
{
    return nit.Command.definePlugin ("postgresql.commandplugins.DatabaseProvider")
        ...
        .method ("preRun", async function (ctx)
        {
        ...
        .method ("postRun", async function (ctx)
        {
        ...
        .method ("postFinally", async function (ctx)
        {
