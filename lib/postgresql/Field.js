module.exports = function (nit, postgresql, Self)
{
    return (Self = nit.Model.Field.defineSubclass ("postgresql.Field"))
        .k ("constructing", "generated", "owner")
        ...
        .staticMethod ("marshallValue", async function (field, value, ctx)
        {
            ...
            {
                value = value instanceof nit.Object ? value.toPojo () : nit.clone (value);
        ...
        .onPreConstruct ((params, obj, args) => // eslint-disable-line no-unused-vars
        {
            nit.dpv (obj, Self.kConstructing, true, true, false);
        })
        .onPostConstruct (function (field)
        {
            ...
            delete field[Self.kConstructing];
