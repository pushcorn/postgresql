    ...
    return (Self = nit.definePlugin ("postgresql.plugins.QueueServer"))
        ...
        .onUsedBy (function (hostClass)
        {
            ...
            hostClass
                ...
                .field ("concurrency", "integer", "The max number of running jobs.", plugin.concurrency)
                ...
                .defineQueuedTaskMethod ("dequeue", Dequeue =>
                {
                    Dequeue
                        ...
                        .lifecycleMethod ("updateJob", false, (job) => job.update ({ status: "running" }))
                ...
                {
                    GetStats
                        .lifecycleMethod ("buildQuery") // (query) => {}
